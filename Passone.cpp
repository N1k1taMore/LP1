...
class Assembler {
    ...
    Assembler() {
        ...
        intCode.open("intermediate.txt", ios::out);
        if (!intCode.is_open()) {
            cout<<"Error opening file"<<endl;
        }

        symbTab.open("symboltable.txt", ios::out);
        if (!symbTab.is_open()) {
            cout<<"Error opening file"<<endl;
        }
        ...
        poolTab.open("pool_tab.txt", ios::out);
        if (!poolTab.is_open()) {
            cout<<"Error opening file"<<endl;
        }
    }
                        ...
                        if (words.size() == 3) {
                            ...
                            if (isdigit(words[2].at(0))) {
                                ...
                                if (index >= 0) {
                                 ...
                                 intCode<<lc<<" "<<"("<<ic.first<<", "<<ic.second<<")"<<" "<<"("<<ic1.first<<", "<<ic1.second<<")"<<" "<<"("<<ic2.first<<", "<<ic2.second<<")"<<endl;
